...
module.exports = async (deployer, network, [defaultAccount]) => {
 /*   if(!network.startsWith('kovan')){
        console.log("Currently only works with Kovan testnet, bye!")
...
*/
        ...
        await deployer.deploy(Lottery, ETH_USD_PRICE_FEED, KOVAN_VRF_COORDINATOR, KOVAN_LINK_TOKEN, KOVAN_KEYHASH);
//   }
}
